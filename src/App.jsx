  ...
  function App() {
    ...
    const addToCart = (itemId, quantity) => {
      fetch('/api/cart/add', {
        ...
        .then(response => response.json())
        .then(data => setCart(data.cart)) // Update local cart state
...
// FOOD
  ...
  return (
    <div>
      ...
      {/* Render the Products component, passing the addToCart function */}
      <Products addToCart={addToCart} />

      {/* Render the Cart component, passing cart, updateCart, and removeFromCart */}
